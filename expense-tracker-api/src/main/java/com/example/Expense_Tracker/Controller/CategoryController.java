...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<List<CategoryResponse>> getCategory(@RequestParam(required = false) Category.CategoryType type){
        if(type!=null){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CategoryResponse> updateCategory(@Valid
